...
\item It largely targets the SVG element, which is being increasingly supported across all major browsers:
    \begin{itemize}
    ...
    \item Opera, 9.5+
    \end{itemize}
\item Should be noted that JavaScript has had huge investments in increaing its performance recently
\begin{itemize}
\end{frame}
